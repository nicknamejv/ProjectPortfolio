                            ...
                            <div className="card" id="project-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text p-4">
                                        Journey Japan is a web application that will captivate those who are traveling, planning, or thinking of going to Japan.The goal for Journey Japan is cultivate real user reviews on the top attractions and places to eat for each of the top cities in Japan.
                                    </p>
                        ...
                        <div className="m-2 p-3">
                            <div className="card" id="project-card">
                                ...
                                <div class="card-body">
                                    <h4>WEEBS R US</h4>
                                    <p class="card-text p-4">
                                        Weebs R Us is pair programmed project in which we recreated a site using NEM stack and the goal is improving on the overall user experience and reverse engineering three key features from that site. It allows users to create comments and showcase a recommend list onto the home page.
                                    </p>
                                    <p id="project-tech" className="p-4">
