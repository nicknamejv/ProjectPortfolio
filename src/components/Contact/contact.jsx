      ...
      <div class="container-fluid px-3 px-lg-5">
        <div class="row gx-4 gx-lg-5 justify-content-center">
          ...
          <div className="row g-0 m-2 py-5" id="contact-background">
            <div
              id="contact-section"
              className="d-flex justify-conntent-evenly flex-wrap"
            >
              <p class="mb-4" id="contact-links">
                <a
                  className="nav-link"
                  href="mailto:jonver.delacruz1@gmail.com"
                  rel="noreferrer"
                  target="_blank"
                >
                  <span>
                  ...
                  <span className="px-2">jonver.delacruz1@gmail.com</span>
                </a>
              </p>
              <p class="mb-4" id="contact-links">
                <a
                ...
                >
                  ...
                  <span className="px-2">nicknamejv</span>
                </a>
              </p>
              <p class="mb-4" id="contact-links">
                <a
                  className="nav-link"
                  href="https://www.linkedin.com/in/jonverdelacruz/"
                  target="_blank"
                >
                  <span>
                    <svg
                  ...
                  <span className="px-2">/in/jonverdelacruz</span>
                </a>
              </p>
              <p class="mb-4" id="contact-links">
