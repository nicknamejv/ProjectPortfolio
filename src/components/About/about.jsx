                    ...
                    <div class="col-lg-8 text-center">
                        ...
                        <div className="row g-0 m-2 py-5" id="about-background">
                            ...
                            <div className="col-md-8">
                                ...
                                <p class="mb-4" id="about-description">
                                    When I'm not coding you'll find me somewhere around the world. I love traveling and visiting national parks so far I have visited all the major parks in the western United States. I also have a long list of hobbies that include photography, videography, and the occasional video game sessions. 
                                </p>
                            </div>
                        </div>
                </div>
